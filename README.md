...
Run the test suite to verify matching, atomic active/cancellation cooldown behavior, active-alert cancellation resets, message deduplication, rollback behavior, rate limiting, and timeout escapes:
