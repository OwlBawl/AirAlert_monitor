...
def setup_bot_handlers(
    ...
    async def handle_help(event: events.NewMessage.Event) -> None:
        ...
        help_text = (
            ...
            "• <code>[слово]</code> (в дужках) — <b>ТОЧНИЙ збіг</b> окремого слова чи фрази без відмінків (напр. <i>[бр]</i> не зреагує на <i>зброя</i>, а <i>[балістика київ]</i> шукатиме точну фразу)\n"
            "• <code>[слово] [інше]</code> — <b>Декілька точних слів</b> де завгодно в тексті (напр. <i>[балістика] [київ]</i>)\n"
